...
urlpatterns = (
    ...
    path('<int:meeting_pk>/assistant/<int:notification_pk>/notification-text/', views.edit_notification_text, name='meetings.edit_notification_answer'),
    path('<int:meeting_pk>/assistant/<int:vote_pk>/vote-text/', views.edit_vote_text, name='meetings.edit_vote_text'),
