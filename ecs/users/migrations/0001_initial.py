    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(related_name='ecs_invitations', to=settings.AUTH_USER_MODEL, on_delete=models.PROTECT)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('communication_proxy', models.ForeignKey(to=settings.AUTH_USER_MODEL, null=True, on_delete=models.PROTECT)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(related_name='ecs_settings', to=settings.AUTH_USER_MODEL, on_delete=models.PROTECT)),
            ],
            options={
            },
            bases=(models.Model,),
