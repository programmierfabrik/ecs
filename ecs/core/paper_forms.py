...
FormInfo(SubmissionForm, fields=(
    ...
    FieldInfo(None, 'subject_maxage_not_defined', 'Kein Höchstalter im Protokoll definiert'),
    ...
    FieldInfo('7.11', 'german_benefits_info', _('Expected benefits for the included test participants'), help_text='von besonderer Bedeutung beim Einschluss geschützter Gruppen: die Beschreibung eines direkten Nutzens aus der Teilnahme'),
