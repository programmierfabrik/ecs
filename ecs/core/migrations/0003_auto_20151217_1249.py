...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='submissionform',
            name='pdf_document',
            field=models.OneToOneField(related_name='submission_form', null=True, to='documents.Document', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submissionform',
            name='presenter',
            field=models.ForeignKey(related_name='presented_submission_forms', to=settings.AUTH_USER_MODEL, on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submissionform',
            name='primary_investigator',
            field=models.OneToOneField(null=True, to='core.Investigator', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submissionform',
            name='sponsor',
            field=models.ForeignKey(related_name='sponsored_submission_forms', to=settings.AUTH_USER_MODEL, null=True, on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submissionform',
            name='submission',
            field=models.ForeignKey(related_name='forms', to='core.Submission', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submissionform',
            name='submitter',
            field=models.ForeignKey(related_name='submitted_submission_forms', to=settings.AUTH_USER_MODEL, null=True, on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submissionform',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(related_name='current_for_submission', null=True, to='core.SubmissionForm', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submission',
        ...
        migrations.AddField(
            model_name='submission',
            name='presenter',
            field=models.ForeignKey(related_name='presented_submissions', to=settings.AUTH_USER_MODEL, on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='submission',
            name='susar_presenter',
            field=models.ForeignKey(related_name='susar_presented_submissions', to=settings.AUTH_USER_MODEL, on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='nontesteduseddrug',
            name='submission_form',
            field=models.ForeignKey(to='core.SubmissionForm', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='measure',
            name='submission_form',
            field=models.ForeignKey(related_name='measures', to='core.SubmissionForm', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='investigatoremployee',
            name='investigator',
            field=models.ForeignKey(related_name='employees', to='core.Investigator', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='investigator',
            name='ethics_commission',
            field=models.ForeignKey(related_name='investigators', to='core.EthicsCommission', null=True, on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='investigator',
            name='submission_form',
            field=models.ForeignKey(related_name='investigators', to='core.SubmissionForm', on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='investigator',
            name='user',
            field=models.ForeignKey(related_name='investigations', to=settings.AUTH_USER_MODEL, null=True, on_delete=models.PROTECT),
            preserve_default=True,
        ),
        migrations.AddField(
