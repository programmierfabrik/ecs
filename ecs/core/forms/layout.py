...
SUBMISSION_FORM_TABS = (
    ...
    Tab('participants', _('participant'), [
        (_('test participant'), [
            ...
            'subject_noncompetents', 'subject_noncompetent_unconscious', 'subject_noncompetent_guarded', 'subject_noncompetent_minor', 'subject_noncompetent_emergency_study', 'subject_duration', 'subject_duration_active', 'subject_duration_controls', 'subject_planned_total_duration',
        ]),
    ]),
    ...
    Tab('applicant', _('applicant'), [
        (_('applicant'), [
            'submitter_contact_gender', 'submitter_contact_title', 'submitter_contact_suffix_title', 'submitter_contact_first_name', 'submitter_contact_last_name', 'submitter_email',
