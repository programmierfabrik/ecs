...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='current_pending_vote',
            field=models.OneToOneField(null=True, to='votes.Vote', related_name='_currently_pending_for', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='submission',
            name='current_published_vote',
            field=models.OneToOneField(null=True, to='votes.Vote', related_name='_currently_published_for', on_delete=models.CASCADE),
        ),
        migrations.RunSQL('''
