    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission_form', models.ForeignKey(related_name='votes', to='core.SubmissionForm', null=True, on_delete=models.PROTECT)),
                ('top', models.OneToOneField(related_name='vote', null=True, to='meetings.TimetableEntry', on_delete=models.PROTECT)),
                ('upgrade_for', models.OneToOneField(related_name='previous', null=True, to='votes.Vote', on_delete=models.PROTECT)),
            ],
            options={
