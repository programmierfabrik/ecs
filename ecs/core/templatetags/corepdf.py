...
from ecs.core.models.constants import SUBMISSION_AGE_UNIT
...
def print_logo_url():
    ...
    return 'data:{};base64,{}'.format(s.print_logo_mimetype, base64.b64encode(s.print_logo).decode('ascii'))


@register.filter
def age_unit(unit):
    return SUBMISSION_AGE_UNIT[unit - 1][1]
