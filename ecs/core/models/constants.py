...
SUBMISSION_DIVERS_YES = 0
SUBMISSION_DIVERS_NO = 1
SUBMISSION_DIVERS_UNDEFINED = 2

SUBMISSION_DIVERS_CHOICES = (
    (SUBMISSION_DIVERS_YES, _('yes')),
    (SUBMISSION_DIVERS_NO, _('no')),
    (SUBMISSION_DIVERS_UNDEFINED, _('undefined')),
)
