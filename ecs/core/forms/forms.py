...
class SubmissionFormForm(ReadonlyFormMixin, forms.ModelForm):
    ...
    class Meta:
        ...
        fields = (
            ...
            'project_type_medical_device_performance_evaluation', 'medtech_combination_studies', 'project_type_non_interventional_study_mpg', 'project_type_basic_research', 'project_type_genetic_study', 'project_type_register',
