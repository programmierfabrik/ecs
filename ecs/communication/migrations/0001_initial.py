    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_message', models.OneToOneField(related_name='head', null=True, to='communication.Message', on_delete=models.CASCADE)),
                ('receiver', models.ForeignKey(related_name='incoming_threads', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('related_thread', models.ForeignKey(to='communication.Thread', null=True, on_delete=models.CASCADE)),
                ('sender', models.ForeignKey(related_name='outgoing_threads', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
