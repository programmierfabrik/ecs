...
class SubmissionForm(models.Model):
    submission = models.ForeignKey('core.Submission', related_name="forms", on_delete=models.CASCADE)
    ethics_commissions = models.ManyToManyField('core.EthicsCommission', related_name='submission_forms', through='Investigator')
    pdf_document = models.OneToOneField(Document, related_name="submission_form", null=True, on_delete=models.CASCADE)
    ...
    study_plan_statalgorithm = models.CharField(max_length=160)
...
class Investigator(models.Model):
    submission_form = models.ForeignKey(SubmissionForm, related_name='investigators', on_delete=models.CASCADE)
    ethics_commission = models.ForeignKey('core.EthicsCommission', related_name='investigators', on_delete=models.CASCADE)
...
class ParticipatingCenterNonSubject(models.Model):
    ...
    ethics_commission = models.ForeignKey('core.EthicsCommission', on_delete=models.CASCADE)
