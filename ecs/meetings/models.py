...
class Participation(models.Model):
    ...
    medical_category = models.ForeignKey(MedicalCategory, related_name='meeting_participations', null=True, blank=True, on_delete=models.CASCADE)
    task = models.ForeignKey('tasks.Task', null=True, on_delete=models.CASCADE)
